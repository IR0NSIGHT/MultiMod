...
public class BuildModeDrawer implements Drawable {
    ...
    private void drawFor(SegmentController var1) {
        ...
        if (var1 != null) {
            ...
            if (var1 instanceof Ship) {
                ...
                if (((var14 = this.getActiveBuildController().getSymmetryPlanes()).isXyPlaneEnabled() || var14.isXzPlaneEnabled() || var14.isYzPlaneEnabled()) && EngineSettings.G_SHOW_SYMMETRY_PLANES.isOn()) {
                ...
                if (var14.getPlaceMode() > 0) {
                    this.drawCurrentSymetriePlanesElement(var1, (Transform)null, var14.getPlaceMode(), this.toBuildPos, (float)var14.getExtraDist() * 0.5F);
                }
                ...
                ShaderLibrary.selectionShader.unload();
                this.mesh.unloadVBO(true);
                if ((var14 = this.getSegmentControlManager().getSegmentBuildController().getSymmetryPlanes()).isXyPlaneEnabled() || var14.isXzPlaneEnabled() || var14.isYzPlaneEnabled()) {
                    this.drawCurrentSymetriePlanesElement(var1);
                }
    ...
    public void drawCurrentSymetriePlanesElement(SegmentController var1) {
        SymmetryPlanes var2 = this.getActiveBuildController().getSymmetryPlanes();
        GlUtil.glEnable(2929);
        GlUtil.glDisable(2896);
        GlUtil.glEnable(3042);
        GlUtil.glBlendFunc(770, 771);
        ...
        GlUtil.glDisable(2884);
        Vector3f var3 = new Vector3f((float)(var2.getYzPlane().x - 16) + (float)var2.getYzExtraDist() * 0.5F, (float)(var2.getXzPlane().y - 16) + (float)var2.getXzExtraDist() * 0.5F, (float)(var2.getXyPlane().z - 16) + (float)var2.getXyExtraDist() * 0.5F);
        this.t.set(var1.getWorldTransform());
        GlUtil.glPushMatrix();
        GlUtil.glMultMatrix(this.t);
        GL11.glBegin(1);
        if (var2.isXyPlaneEnabled() && var2.isXzPlaneEnabled() && var2.isYzPlaneEnabled()) {
            GL11.glVertex3f((float)(var1.getMinPos().x << 5), var3.y, var3.z);
            GL11.glVertex3f((float)(var1.getMaxPos().x << 5), var3.y, var3.z);
            GL11.glVertex3f(var3.x, (float)(var1.getMinPos().y << 5), var3.z);
            GL11.glVertex3f(var3.x, (float)(var1.getMaxPos().y << 5), var3.z);
            GL11.glVertex3f(var3.x, var3.y, (float)(var1.getMinPos().z << 5));
            GL11.glVertex3f(var3.x, var3.y, (float)(var1.getMaxPos().z << 5));
        } else if (var2.isXyPlaneEnabled() && var2.isXzPlaneEnabled()) {
            GL11.glVertex3f((float)(var1.getMinPos().x << 5), var3.y, var3.z);
            GL11.glVertex3f((float)(var1.getMaxPos().x << 5), var3.y, var3.z);
        } else if (var2.isXyPlaneEnabled() && var2.isYzPlaneEnabled()) {
            GL11.glVertex3f(var3.x, (float)(var1.getMinPos().y << 5), var3.z);
            GL11.glVertex3f(var3.x, (float)(var1.getMaxPos().y << 5), var3.z);
        } else if (var2.isXzPlaneEnabled() && var2.isYzPlaneEnabled()) {
            GL11.glVertex3f(var3.x, var3.y, (float)(var1.getMinPos().z << 5));
            GL11.glVertex3f(var3.x, var3.y, (float)(var1.getMaxPos().z << 5));
        }
        ...
        GlUtil.glDisable(3042);
        float var4;
        if (var2.isXyPlaneEnabled()) {
            var4 = (float)var2.getXyExtraDist() * 0.5F;
            this.drawCurrentSymetriePlanesElement(var1, (Transform)null, 1, var2.getXyPlane(), var4);
        }

        if (var2.isXzPlaneEnabled()) {
            var4 = (float)var2.getXzExtraDist() * 0.5F;
            this.drawCurrentSymetriePlanesElement(var1, (Transform)null, 2, var2.getXzPlane(), var4);
        }

        if (var2.isYzPlaneEnabled()) {
            var4 = (float)var2.getYzExtraDist() * 0.5F;
            this.drawCurrentSymetriePlanesElement(var1, (Transform)null, 4, var2.getYzPlane(), var4);
        }
    ...
    private void drawReactorCoordinateSystem(SegmentController var1, ReactorTree var2) {
        ...
        this.drawCurrentSymetriePlanesElement(var1, var3, 1, var13, 0.0F, var6, var7, var4, var5);
        this.drawCurrentSymetriePlanesElement(var1, var3, 2, var13, 0.0F, var8, var9, var4, var5);
        this.drawCurrentSymetriePlanesElement(var1, var3, 4, var13, 0.0F, var10, var11, var4, var5);
    ...
    static class MySuperEpicBuildModeClass{
        int weed = 0;
    }
}
