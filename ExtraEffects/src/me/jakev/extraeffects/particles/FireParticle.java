 ...
 */
public class FireParticle extends ModParticle {
    private Vector3f dir;
    private final float offset;
    static Vector4f startColor = new Vector4f(1,1,1,1);
    static Vector4f endColor = new Vector4f(0.6F,0,0,0F);

    public FireParticle(Vector3f dir, float offset){
        this.dir = dir;
        this.offset = offset;
    }
    ...
    public void update(long currentTime) {
        ...
        sizeOverTime(this, currentTime, 6, 77);
        rotate(this, ticksLived/200F);
