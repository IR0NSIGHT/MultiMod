...
public class AlphaRework extends StarMod {
    ...
    public void onUniversalRegistryLoad() {
        UniversalRegistry.registerURV(UniversalRegistry.RegistryType.PLAYER_USABLE_ID, this.getSkeleton(), ShieldHardenAddOn.UID_NAME);
        UniversalRegistry.registerURV(UniversalRegistry.RegistryType.PLAYER_USABLE_ID, this.getSkeleton(), AlphaDriverAddOn.UID_NAME);
    }
    ...
    public void onEnable() {
        StarLoader.registerListener(CubeTexturePostLoadEvent.class, new Listener<CubeTexturePostLoadEvent>() {
            ...
            public void onEvent(CubeTexturePostLoadEvent event) {
                try {
                    betterCrossHair = StarLoaderTexture.newSprite(ImageIO.read(alphaRework.getJarResource("me/jakev/alpharework/sprites/crosshair.png")), alphaRework, "mycrosshair");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
        ...
        StarLoader.registerListener(RegisterAddonsEvent.class, new Listener<RegisterAddonsEvent>() {
            ...
            public void onEvent(RegisterAddonsEvent event) {
                System.err.println("[AlphaRework] Fired register addons");
